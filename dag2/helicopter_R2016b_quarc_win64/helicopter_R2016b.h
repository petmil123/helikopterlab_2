 ...
 * '<S3>'   : 'helicopter_R2016b/Elevation controller'
 * '<S4>'   : 'helicopter_R2016b/Helicopter_interface'
 * '<S5>'   : 'helicopter_R2016b/Pitch controller'
 * '<S6>'   : 'helicopter_R2016b/Elevation controller/If Action Subsystem'
 * '<S7>'   : 'helicopter_R2016b/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter_R2016b/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter_R2016b/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter_R2016b/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter_R2016b/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter_R2016b/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter_R2016b/Helicopter_interface/Travel rate  rad to deg'
 */
